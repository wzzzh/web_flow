...
$.extend(true,myflow.config.rect,{
	attr : {
	r : 8,			//模块的border-radius
	fill : '#F6F7FF',		//模块的填充颜色
	stroke : '#03689A',		//模块的边框颜色
	"stroke-width" : 2	//模块边框的颜色
}
});
...
$.extend(true,myflow.config.tools.states,{
	start : {
		showType: 'image',				//展现的形式(image,text,image&text)
		type : 'start',					//类型，与左侧工具栏类型相同
		name : {text:'<<start>>'},
		text : {text:'开始'},
	...
	task : {
		...
		name : {text:'<<task>>'},
		text : {text:'任务'},
		img : {src : 'img/newImg/pic_03.png',width :48, height:48},
		props : {
