    ...
    myflow.editors = {
        textEditor: function () {
            ...
            this.init = function (props, k, div, src, r) {
                ...
                $('<input class="aaa" style="width:100%;"/>').val(_src.text()).change(
                    function () {
    ...
    myflow.init = function (c, o) {
        ...
        */
        ...
        $(_r).bind('addrect', function (e, type, o) {
            ...
            myflow.config.tools.addRect(rect.getId(),rect.toJson(),getJson());
        });
